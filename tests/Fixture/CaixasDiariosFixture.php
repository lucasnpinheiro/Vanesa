...
class CaixasDiariosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'terminal' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'terminal' => 1,
            'pessoa_id' => 1,
            'created' => '2016-03-05 00:31:46',
            'modified' => '2016-03-05 00:31:46'
        ],
    ];
}
