 ...
 */
class OperadoresCaixasController extends AppController {

    public function __construct(\Cake\Network\Request $request = null, \Cake\Network\Response $response = null, $name = null, $eventManager = null, $components = null) {
        parent::__construct($request, $response, $name, $eventManager, $components);
        $this->set('titulo_pagina', 'Operadores de Caixas');
    ...
    public function index() {
        ...
        $find = $this->PessoasTipos->find('all')->where(['tipo' => 5])->all();
        $ids = [];
    ...
    public function delete($id = null) {
        ...
        $this->loadModel('PessoasTipos');
        $pessoa = $this->PessoasTipos->find()->where(['pessoa_id' => $id, 'tipo' => 5])->first();
