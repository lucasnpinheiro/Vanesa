...
INSERT  IGNORE INTO `parametros` (`id`, `nome`, `chave`, `valor`, `tipo`, `opcoes`, `grupo`, `root`, `required`) VALUES (1,'Liberar Desconto em','D_Pedido_Local','I',4,'{\"A\":\"Ambos\", \"I\":\"Item\", \"P\":\"Pedido\"}','Pedido',0,1),(2,'Desconto no Item','D_Pedido_Item','50,0000',6,NULL,'Pedido',0,0),(3,'Desconto no Total do Pedido','D_Pedido','5,0000',6,NULL,'Pedido',0,0),(4,'Casas Decimais','N_Casas_Decimais','3',4,'[0,1,2,3,4]','Produtos',1,1),(5,'Codigo de Acesso','C_Acesso','a:7:{s:12:\"data_geracao\";s:10:\"2016-04-06\";s:13:\"data_validade\";s:10:\"2016-05-21\";s:7:\"cliente\";s:15:\"Empresa Teste 1\";s:4:\"cnpj\";s:18:\"16.529.383/0001-20\";s:5:\"ativo\";i:1;s:3:\"md5\";s:32:\"5df678f941505f5e10d60963d1b8f872\";s:5:\"token\";s:324:\"\";}',2,NULL,'Sistema',1,0),(6,'Data do Ultimo Acesso','C_Acesso_Data','20160329215004',2,NULL,'Sistema',1,0),(7,'Codigo de Acesso da Empresa','C_Acesso_Empresa','5df678f941505f5e10d60963d1b8f872',2,NULL,'Sistema',1,0),(8,'Carregar tela pagamento ao finalizar o pedido.','P_Tela_Pagamento','1',4,'[\"Não\",\"Sim\"]','Pedido',0,1),(9,'Quantidade maxima de parcelas','C_Max_Parcelas','5',1,'','Pedido',0,1),(10,'Novo pedido ao finalizar pagamento','P_Tela_Pedido','1',4,'[\"Não\",\"Sim\"]','Pedido',0,1),(11,'Data Validade','C_Acesso_Data_Validade','2016-05-21',2,NULL,'Sistema',1,0);
...
INSERT  IGNORE INTO `pedidos_itens` (`id`, `pedido_id`, `produto_id`, `sequencia`, `valor_venda`, `quantidade`, `valor_total`, `perc_desconto`, `valor_desconto`, `valor_liquido`, `created`, `modified`) VALUES (1,1,1,0,48.90,0.3500,17.11,NULL,NULL,17.11,'2016-04-06 18:40:09','2016-04-06 18:40:09'),(2,1,187,1,3.00,1.0000,3.00,NULL,NULL,3.00,'2016-04-06 18:40:14','2016-04-06 18:40:14');
...
CREATE TABLE `produtos` (
  ...
  `nome_atalho` varchar(12) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `modified` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2016-04-06 22:17:04
